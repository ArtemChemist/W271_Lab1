...
model_cereal_shelves_trim <- multinom(formula = Shelf ~ sugar_g_norm + sodium_mg_norm, data = cereal)
...
df_to_plot <- data.frame(fat_g_norm = rep(fat_mean, times = 100), sodium_mg_norm = rep(na_mean, times = 100), sugar_g_norm = seq(1, 100) / 100)
